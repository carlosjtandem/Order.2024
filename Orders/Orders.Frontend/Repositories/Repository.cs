    ...
    public class Repository : IRepository
    {
        ...
        public async Task<HttpResponseWrapper<T>> GetAsync<T>(string url)
        {
            ...
            if (responseHttp.IsSuccessStatusCode)
            {
                ...
                var response = await UnserializeAnswser<T>(responseHttp); //esto es un metodo propio.
        ...
        public async Task<HttpResponseWrapper<TActionResponse>> PostAsync<T, TActionResponse>(string url, T model) // Post que envia un T y devuelve TActionRespuesta
        {
            ...
            {
                //tengo que desearelizar la respuesta
                var response = await UnserializeAnswser<TActionResponse>(responseHttp); //esto es un metodo propio.
        ...
        private async Task<T> UnserializeAnswser<T>(HttpResponseMessage responseHttp)
        {
